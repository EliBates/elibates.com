...
<nav class="navbarDesktop" role="navigation">
	<ul>
		<li class="logo">
			<a href="/">
				<picture>
					<source type="image/avif" srcset="/avif/eli.avif" />
					<img src="/eli.png" alt="Portrait of Eli Bates" />
				</picture>
				<div>
					<h1>Eli Bates</h1>
					<h2>Web Developer</h2>
		...
		<li>
			<a class="navLink" href="https://github.com/elibates" target="_blank"
